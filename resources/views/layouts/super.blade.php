                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-center navbar-menu-wrapper">
                        <ul class="navbar-nav">
                            ...
                            <div
                                class="d-flex align-items-center justify-content-center text-center navbar-brand-wrapper">
                        ...
                        <ul class="navbar-nav-right navbar-nav">
                             <li class="nav-item nav-profile dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                                    id="profileDropdown">
                                    <span class="nav-profile-name">{{ auth('web')->user()->name }}</span>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu submenu" aria-labelledby="adminDropdown">
                                    <ul class="submenu-item">
                                        <li class="nav-item">
                                            <a class="dropdown-item" href="{{ route('create.admin') }}">Create
                                                Admin</a>
                                        </li>
                                        <li class="nav-item">
