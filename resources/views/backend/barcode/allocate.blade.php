                        ...
                        <tbody>
                            @foreach ($allocatedBarcode as $barcode)
                                <tr>
                                    ...
                                    <td>
                                        <span class="bg-primary badge">{{ $barcode->barcode->barcodeNo ?? 'N/A' }}</span>
                                    </td>
                                    ...
                                    <td class="pe-4 text-end">
                                        ...
                                        @if ($barcode->status == 0)
                                            {{-- ✅ Active -> Allow revoke --}}
                                            <form action="{{ route('barcode.rollback', $barcode->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn-outline-danger btn btn-sm"
                                                    title="Revoke Allocation"
                                                    onclick="return confirm('Are you sure you want to revoke this allocation?');">
                                                    <i class="fas fa-undo"></i>
                                                </button>
                                            </form>
                                        @else
                                            {{-- ❌ Used -> Show alert only --}}
                                            <button type="button" class="btn-outline-secondary btn btn-sm"
                                                title="Revoke Not Allowed"
                                                onclick="alert('Device is in use, cannot rollback!');">
                                                <i class="fas fa-undo"></i>
                                            </button>
                                        @endif
                                    </td>
                            ...
                            <form action="{{ route('barcode.allocate.store') }}" method="post">
                                ...
                                <div class="mb-4 row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select state @error('state') is-invalid @enderror"
                                            name="state">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select dealer @error('dealer') is-invalid @enderror"
                                            name="dealer">
                                ...
                                <div class="mb-4 row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select element @error('element') is-invalid @enderror"
                                            name="element">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select voltage @error('voltage') is-invalid @enderror"
                                            name="voltage">
                                ...
                                <div class="shadow-sm mb-4 border-0 card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div
                                                class="d-flex flex-column align-items-center justify-content-center col-md-2">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <select id="allocated_barcodes" class="form-select" multiple
                                                    size="8" name="allocated_barcodes[]">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="me-3 btn-outline-secondary btn"
