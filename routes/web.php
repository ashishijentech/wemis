...
Route::middleware(['auth:manufacturer'])->prefix('manufacturer')->group(function () {
    ...
    Route::get('/barcode/edit/{id}', [BarcodeController::class, 'edit'])->name('barcode.edit');
...
Route::middleware(['multi.guard.auth:manufacturer,distributor,dealer,technician'])->group(function () {
    ...
    Route::get('/map-device/data-log/{deviceId}', [DeviceController::class, 'dataLog'])->name('map.device.dataLog');
    Route::get('/map-device/documents/{deviceId}', [DeviceController::class, 'documents'])->name('map.device.documents');
    Route::get('/map-device/edit/{deviceId}', [DeviceController::class, 'edit'])->name('map.device.edit');
    Route::post('/map-device/update/{deviceId}', [DeviceController::class, 'update'])->name('map.device.update');
    Route::get('/map-device/view/{deviceId}', [DeviceController::class, 'view'])->name('map.device.view');

    Route::get('/device/location/view/{imei}', [DeviceController::class, 'tracking']);
    Route::get('/device/location/{imei}', [DeviceController::class, 'latestLocation']);
